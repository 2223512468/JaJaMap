...
import com.jajamap.view.IndoorPoiOverlay;


public class IndoorSearchAct extends Activity implements OnGetPoiSearchResultListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        LatLng centerpos = new LatLng(30.287085, 120.233859); // 北京南站
     ...
     //   stripView = (StripListView) findViewById(R.id.stripView);
        ...
        searchBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (indoorInfo == null) {
                    Toast.makeText(IndoorSearchAct.this, "当前无室内图，无法搜索" , Toast.LENGTH_LONG).show();
                    return;
                }
    ...
    public void onGetPoiIndoorResult(PoiIndoorResult result) {
        ...
        if (result == null  || result.error == PoiIndoorResult.ERRORNO.RESULT_NOT_FOUND) {
            Toast.makeText(IndoorSearchAct.this, "无结果" , Toast.LENGTH_LONG).show();
            return;
        }
    ...
    private class MyIndoorPoiOverlay extends IndoorPoiOverlay {
        ...
        public boolean onPoiClick(int i) {
            ...
            Toast.makeText(IndoorSearchAct.this, info.name + ",在" + info.floor + "层", Toast.LENGTH_LONG).show();
            return false;
        }
