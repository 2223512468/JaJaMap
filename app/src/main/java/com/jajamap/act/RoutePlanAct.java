...
import com.jajamap.adapter.RouteLineAdapter;
import com.jajamap.view.BikingRouteOverlay;
import com.jajamap.view.DrivingRouteOverlay;
import com.jajamap.view.MassTransitRouteOverlay;
import com.jajamap.view.OverlayManager;
import com.jajamap.view.TransitRouteOverlay;
import com.jajamap.view.WalkingRouteOverlay;
 ...
 * 同时展示如何进行节点浏览并弹出泡泡
 */
public class RoutePlanAct extends Activity implements BaiduMap.OnMapClickListener,
    ...
    public void searchButtonProcess(View v) {
        ...
        PlanNode stNode = PlanNode.withCityNameAndPlaceName("杭州", startNodeStr);
        PlanNode enNode = PlanNode.withCityNameAndPlaceName("杭州", endNodeStr);
    ...
    public void nodeClick(View v) {
        ...
        // show popup
        popupText = new TextView(RoutePlanAct.this);
    ...
    public void onGetWalkingRouteResult(WalkingRouteResult result) {
        if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
            Toast.makeText(RoutePlanAct.this, "抱歉，未找到结果", Toast.LENGTH_SHORT).show();
        }
        if (result.error == SearchResult.ERRORNO.AMBIGUOUS_ROURE_ADDR) {
            // 起终点或途经点地址有岐义，通过以下接口获取建议查询信息
            // result.getSuggestAddrInfo()
            AlertDialog.Builder builder = new AlertDialog.Builder(RoutePlanAct.this);
            builder.setTitle("提示");
        ...
        if (result.error == SearchResult.ERRORNO.NO_ERROR) {
            ...
            if (result.getRouteLines().size() > 1) {
                ...
                if (!hasShownDialogue) {
                    MyTransitDlg myTransitDlg = new MyTransitDlg(RoutePlanAct.this,
