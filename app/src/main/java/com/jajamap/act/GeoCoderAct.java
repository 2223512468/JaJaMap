...
public class GeoCoderAct extends Activity implements OnGetGeoCoderResultListener {
    ...
    public void onGetGeoCodeResult(GeoCodeResult result) {
        if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
            Toast.makeText(GeoCoderAct.this, "抱歉，未能找到结果", Toast.LENGTH_LONG)
                    .show();
            return;
        }
        mBaiduMap.clear();
        ...
        Toast.makeText(GeoCoderAct.this, strInfo, Toast.LENGTH_LONG).show();
    }
    ...
    public void onGetReverseGeoCodeResult(ReverseGeoCodeResult result) {
        ...
        mBaiduMap.setMapStatus(MapStatusUpdateFactory.newLatLng(result
                .getLocation()));
        Toast.makeText(GeoCoderAct.this, result.getAddress() + " adcode: " + result.getAdcode(),
