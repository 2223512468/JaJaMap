...
import com.jajamap.indoorview.BaseStripAdapter;
import com.jajamap.indoorview.StripListView;
import com.jajamap.view.IndoorRouteOverlay;


public class IndoorMapAct extends Activity implements OnGetRoutePlanResultListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        LatLng centerpos = new LatLng(30.287085, 120.233859); // 西单大悦城
        ...
        mFloorListAdapter = new BaseStripAdapter(IndoorMapAct.this);
    ...
    public void nodeClick(View v) {
        if (mBaiduMap.isBaseIndoorMapMode()) {
            ...
            // show popup
            popupText = new TextView(IndoorMapAct.this);
...
//        mFloorListAdapter.setSelectedPostion();
            ...
            Toast.makeText(IndoorMapAct.this,"请打开室内图或将室内图移入屏幕内", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void EnableIndoorMap() {
        ...
        Toast.makeText(IndoorMapAct.this, "室内图已打开", Toast.LENGTH_SHORT).show();
    }
    ...
    private void DisableIndoorMap() {
        ...
        Toast.makeText(IndoorMapAct.this, "室内图已关闭", Toast.LENGTH_SHORT).show();
    }
}
