 ...
 * 演示短串分享功能，
 */
public class ShareDemoAct extends Activity implements
    ...
    public void onGetPoiResult(PoiResult result) {
        ...
        if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
            Toast.makeText(ShareDemoAct.this, "抱歉，未找到结果",
    ...
    public void onGetRouteShareUrlResult(ShareUrlResult shareUrlResult) {
        ...
        if (null == intent) {
            Toast.makeText(ShareDemoAct.this, "抱歉，分享目标选择失败",
                Toast.LENGTH_LONG).show();
        }
    ...
    public void shareRoute(View view) {
        startNode = PlanNode.withLocation(new LatLng(30.285903, 120.232641));
        enPlanNode = PlanNode.withLocation(new LatLng(30.199308, 120.192864));
