...
import com.jajamap.view.BusLineOverlay;
 ...
 */
public class BusLineSearchAct extends FragmentActivity implements
    ...
    public void onGetBusLineResult(BusLineResult result) {
        if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
            Toast.makeText(BusLineSearchAct.this, "抱歉，未找到结果",
        ...
        Toast.makeText(BusLineSearchAct.this, result.getBusLineName(),
