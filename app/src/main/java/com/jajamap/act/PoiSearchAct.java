...
import com.jajamap.view.PoiOverlay;
 ...
 * 演示poi搜索功能
 */
public class PoiSearchAct extends FragmentActivity implements
    ...
    public void onGetPoiResult(PoiResult result) {
        if (result == null || result.error == SearchResult.ERRORNO.RESULT_NOT_FOUND) {
            Toast.makeText(PoiSearchAct.this, "未找到结果", Toast.LENGTH_LONG)
                    .show();
            return;
        }
        ...
        if (result.error == SearchResult.ERRORNO.AMBIGUOUS_KEYWORD) {
            ...
            strInfo += "找到结果";
            Toast.makeText(PoiSearchAct.this, strInfo, Toast.LENGTH_LONG)
                    .show();
        }
    }
    ...
    public void onGetPoiDetailResult(PoiDetailResult result) {
        if (result.error != SearchResult.ERRORNO.NO_ERROR) {
            Toast.makeText(PoiSearchAct.this, "抱歉，未找到结果", Toast.LENGTH_SHORT)
                    .show();
        } else {
            Toast.makeText(PoiSearchAct.this, result.getName() + ": " + result.getAddress(), Toast.LENGTH_SHORT)
                    .show();
        }
    }
    ...
    public void onGetSuggestionResult(SuggestionResult res) {
        ...
        sugAdapter = new ArrayAdapter<String>(PoiSearchAct.this, android.R.layout.simple_dropdown_item_1line, suggest);
        keyWorldsView.setAdapter(sugAdapter);
